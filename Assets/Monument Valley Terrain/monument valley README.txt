...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=monument+valley&box=-109.992870,37.097806,-110.274436,36.873227
...
-----------
  ...
  * monument valley Height Map (ASTER 30m).png
  ...
  * monument valley Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * monument valley Height Map (SRTM3 v4.1).png
  ...
  * monument valley Height Map (SRTM30 Plus).png
  ...
  * monument valley Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 1440m (actual) is equal to 40m in
